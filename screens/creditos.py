...
_CREDITOS = [
    ("titulo",    "EMPATÍA QUEST"),
    ("subtitulo", "Un juego sobre empatía en el entorno escolar"),
    ("separador", ""),
    ...
    ("separador", ""),
    ("texto",     "A quienes alguna vez hablaron cuando era fácil"),
    ("texto",     "quedarse callados."),
    ("separador", ""),
    ("texto",     "A quienes aprendieron que la empatía"),
    ("texto",     "no es debilidad, sino el acto más valiente."),
    ("separador", ""),
    ("separador", ""),
    ("titulo",    "EMPATÍA QUEST"),

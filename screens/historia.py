...
CAPITULOS = [
    {
        "dia": 1,
        "titulo": "Día 1: Las primeras decisiones",
        "eventos": ["primer_dia", "voces_pasillo"],
        "descripcion": "El primer día de clases y los pasillos del colegio.",
    },
    {
        "dia": 2,
        "titulo": "Día 2: El mundo digital",
        "eventos": ["reenviado", "detras_agresor"],
        "descripcion": "El bullying no para en el colegio - sigue en el celular.",
    },
    {
        "dia": 3,
        "titulo": "Día 3: El precio de encajar",
        "eventos": ["encajar", "broma"],
        "descripcion": "Ser aceptado puede costar más de lo que parece.",
    },
    {
        "dia": 4,
        "titulo": "Día 4: Cuando el daño es invisible",
        "eventos": ["rumores", "no_era_flojera"],
        "descripcion": "Algunos dolores no se ven, pero están ahí.",
    },
    {
        "dia": 5,
        "titulo": "Día 5: Quién eres tú",
        "eventos": ["racismo", "xenofobia"],
        "descripcion": "El final depende de cada decisión que tomaste.",
    },
]
...
def draw(game):
    ...
    game.draw_pixel_text(
        "Tus decisiones día a día", w // 2, title_y + 46, "small", TEXT_SOFT, True
    )
    ...
    for i, cap in enumerate(CAPITULOS):
        ...
        for eid in cap["eventos"]:
            ...
            if dec:
                label = dec.get("option_label", "Decisión tomada")
    ...
    game.draw_pixel_text(
        "ESC para volver al menú", w // 2, h - 24, "small", (62, 74, 98), True
    )
